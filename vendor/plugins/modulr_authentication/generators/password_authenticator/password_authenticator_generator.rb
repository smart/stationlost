require 'digest/sha1'
class PasswordAuthenticatorGenerator < Rails::Generator::NamedBase
  ...
  def manifest
    recorded_session = record do |m|
        m.migration_template 'migration.rb', 'db/migrate', :assigns => {
          :migration_name => "AddPasswordAuthenticatorToUsers"
        }, :migration_file_name => "add_password_authenticator_to_users"
    end
    recorded_session
  end
