...
describe UsersController do
  describe "route generation" do
    it "should route users's 'index' action correctly"   do      route_for(:controller => 'users', :action => 'index'              ).should == "/users"    end
    it "should route users's 'new' action correctly"     do      route_for(:controller => 'users', :action => 'new'                ).should == "/signup"    end
    it "should route users's 'create' action correctly"  do      route_for(:controller => 'users', :action => 'create'             ).should == "/register"  end
    it "should route users's 'show' action correctly"    do      route_for(:controller => 'users', :action => 'show',    :id => '1').should == "/users/1"    end
    it "should route users's 'edit' action correctly"    do      route_for(:controller => 'users', :action => 'edit',    :id => '1').should == "/users/1/edit" end
    it "should route users's 'update' action correctly"  do      route_for(:controller => 'users', :action => 'update',  :id => '1').should == "/users/1"    end
    it "should route users's 'destroy' action correctly" do      route_for(:controller => 'users', :action => 'destroy', :id => '1').should == "/users/1"    end
  end
  ...
  describe "route recognition" do
    ...
    it "should generate params for users's edit action from GET /users/1/edit" do
      ...
      params_from(:get , '/users/1/edit.xml').should  == {:controller => 'users', :action => 'edit', :id => '1', :format => 'xml'}
      params_from(:get , '/users/1/edit.json').should == {:controller => 'users', :action => 'edit', :id => '1', :format => 'json'}
    end
    it "should generate params for users's update action from PUT /users/1" do
  ...
  describe "named routing" do
    ...
    it "should route users_path() correctly" do
    ...
    it "should route new_user_path() correctly" do
    ...
    it "should route user_(:id => '1') correctly" do
    ...
    it "should route edit_user_path(:id => '1') correctly" do
