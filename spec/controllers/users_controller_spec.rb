...
describe UsersController do
  ...
  describe "login page" do
    ...
    it "constructs a new user"      do User.should_receive(:new).with().and_return(@user); do_signup_page; end
  ...
  describe "signing up" do
    ...
    describe "successfully" do
      ...
      it "constructs a new user"                 do User.should_receive(:new).with(default_signup_options).and_return(@user); do_signup; end
