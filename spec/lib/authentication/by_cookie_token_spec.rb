...
describe Authentication do
  before(:each) do
    ...
    stub_auth!(@mock_controller, true) # user is authorized for anything; call stub_auth! again to override.
  end
  ...
  describe "Logging in by cookie" do
    before do
      User.stub!(:find_by_remember_token).with('valid_token').and_return(@user)
