...
protected
  ...
  #
  # Examples:
  #   # allow any user unless it's that guy bob. bob's a jerk.
  #   def get_authorization req
  #     req[:for].is_a(User) && (req[:for].login != "bob")
  #   end
  #
  #   # only active users can do things.
  #   def get_authorization req
  #     user = req[:for]
  #     user.is_a?(User) && user.has_role?(:active)
  #   end
  #
  def get_authorization req
    user = req[:for]
